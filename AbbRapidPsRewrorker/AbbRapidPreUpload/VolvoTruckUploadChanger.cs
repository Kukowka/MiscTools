...
namespace AbbRapidPreUploader
{
    ...
    ///
    /// it swaps spot data with gun data, from:
    ...
    /// </summary>
    /// 
    public class VolvoTruckUploadChanger
    {
        private List<IStd_BR_BackupProc> _procesInFile;
        private readonly Std_BR_AbbVolvoTruckSyntaxFixer _volvoTruckSyntaxFixer = new Std_BR_AbbVolvoTruckSyntaxFixer();
        ...
        {
            var result = _volvoTruckSyntaxFixer.CorrectSyntax(); //this line reduce number of params in spot data and bead data
        ...
        public static bool HasPointSpotMotion(Std_BR_AbbPorscheBackupPoint point)
        {
            return point.Type == Std_BR_AbbPorscheBackupPoint.PointTypes.SpotL || point.Type == Std_BR_AbbPorscheBackupPoint.PointTypes.SpotJ;
        }

        public static string SwapSpotDataWithGunData(Std_BR_AbbPorscheBackupPoint point)
        {
